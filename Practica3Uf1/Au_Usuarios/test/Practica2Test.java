...
public class Practica2Test {
    ...
    public void BaseMostRepetedTest() {
        ...
        char result = tools.baseMesRepetida(cadena);
    ...
    @Test
    public void LongitudCadenaADNTest() {
        String cadenaADN = "AGGTCA";
        DNATools tools = new DNATools();
        int expResult = 6;

        int result = tools.longitudCadenaADN(cadenaADN);
        assertEquals(expResult, result);
    }

    @Test
    public void LongitudCadenaADNFailTest() throws InvalidDNAException {
        String cadenaADN = "AGGTCA";
        DNATools tools = new DNATools();
        int expResult = 6;
        int expError = 4;
        int new_adn = tools.longitudCadenaADN(cadenaADN);
        assertFalse("Error de longitud", new_adn==expError);
    }
